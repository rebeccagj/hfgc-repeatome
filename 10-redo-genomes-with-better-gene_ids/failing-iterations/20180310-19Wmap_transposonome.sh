...
mkdir /scratch/sf040090/19Wmap20180310
cd /scratch/sf040090/19Wmap20180310
...
echo "20180310-19Wmap complete"

# some weird BAM error, changed threads to 6 and reverted to 2.5.3a